...
<link rel="stylesheet" type="text/css" href="{{ site.url }}/{{ baseurl }}/assets/css/site.css" />
<link rel="stylesheet" type="text/css" href="{{ site.url }}/{{ baseurl }}/assets/css/code/github.css" />
...
<script src="{{ site.url }}/{{ baseurl }}/assets/js/site.js"></script>
