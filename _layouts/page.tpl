...
<link rel="stylesheet" type="text/css" href="{{ baseurl }}/assets/css/site.css" />
<link rel="stylesheet" type="text/css" href="{{ baseurl }}/assets/css/code/github.css" />
...
<script src="{{ baseurl }}/assets/js/site.js"></script>
